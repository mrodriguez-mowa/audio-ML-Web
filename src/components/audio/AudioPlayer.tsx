...
const AudioPlayer = ({audio}:IAudioPlayer) => {
    return (
        <div className='mx-auto'>
             ...
             * 
             * 
                <button className='my-8  py-2 flex  rounded-lg bg-red-400 hover:cursor-pointer hover:text-red-100 text-red-700 font-semibold transition-all mx-auto border-2'>
